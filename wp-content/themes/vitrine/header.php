        ...
        <?php if (!epico_is_shop_ajax_request() && !epico_is_djax_request()) { ?>
            ...
            <div class="layout">
                ...
                <?php if (epico_opt('loader_display') == '0') { ?>
                    <div id="preloader" class="firstload <?php
                    echo epico_opt('preloader-type');
                    if (epico_opt('preloader_display')) {
                        echo ' hideInFirstLoad';
                    }
                    ?>">
                        <div id="preloader_box">
                            ...
                            <div class="preloader-text-container">
                                <div class="preloader-text"><?php
                                    if (epico_opt('preloader-text')) {
                                        epico_eopt('preloader-text');
                                    }
                                    ?></div>
                            </div>
                ...
                <?php if (epico_opt('topbar_display') == 1) { ?>
                    ...
                    <div id="topbar" class="hidden-phone hidden-tablet <?php echo esc_attr($topBarStyle); ?>">
                        ...
                        <?php if (epico_opt('boxed_topbar') == 1) { ?>
                            ...
                            <?php } ?>
                            <?php if (epico_opt('topbar-language-link-1') || epico_opt('topbar-language-link-2') || epico_opt('topbar-language-link-3')) { ?>
                            ...
                            <?php } ?>
                            <?php if (class_exists('WooCommerce') && epico_opt('shop-login-link') == 1) { ?>
